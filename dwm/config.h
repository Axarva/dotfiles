...
static const char *fonts[]          = { "Iosevka Nerd Font:size=10:style=bold", "JoyPixels:pixelsize=10", "monospace:size=10" };
...
static const char *colors[][3]      = {
	...
	[SchemeNorm] 		=	 { "#ffffff",     col_black,  		col_black },
	[SchemeSel]  		=	 { "#94d3f7",	  col_black,		col_black },
	[SchemeStatus]  = { "#94d3f7", col_black,  "#000000"  }, // Statusbar right {text,background,not used but cannot be empty}
        [SchemeTagsSel]  = { col_navyblue, col_black,  "#000000"  }, // Tagbar left selected {text,background,not used but cannot be empty}
        [SchemeTagsNorm]  = { "#94d3f7", col_black,  "#000000"  }, // Tagbar left unselected {text,background,not used but cannot be empty}
        [SchemeInfoSel]  = { "#94d3f7", col_black,  "#000000"  }, // infobar middle  selected {text,background,not used but cannot be empty}
        [SchemeInfoNorm]  = { "#94d3f7", col_black,  "#000000"  }, // infobar middle  unselected {text,background,not used but cannot be empty}
...
static const char *goingout[] = { "/home/axarva/bin/powermenu", NULL };
...
static const char *dmenucmd[] = {  "/home/axarva/bin/appsmenu", NULL };
